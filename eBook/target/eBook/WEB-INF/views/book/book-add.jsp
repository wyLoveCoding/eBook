...
<div class="x-body">
    ...
    <form class="layui-form" lay-filter="test1" action="${pageContext.request.contextPath}/Book/add" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="bookauthor" name="bookAuthor" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="bookmoney" name="bookMoney" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="booknum" name="bookNum" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    layui.use(['form'], function () {
        form = layui.form
            , layer = layui.layer;
        $.post("${pageContext.request.contextPath}/Order/style",function(data){
            var field = "";
            console.log(data)
            ...
            form.on('select(select)', function(data){
                ...
                $.ajax({
                    type: 'POST',
                    url: '${pageContext.request.contextPath}/Order/category',
                    data: {field:areaId},
                    dataType:  'json',
...
<script>
    $(function () {
        $("#btn_insert").click(function () {
            ...
            $.ajax({
                "url":"${pageContext.request.contextPath}/Book/img",
                "type": "post",
                "data": formData,
                "dataType": "text",
                processData:false,
