...
<body>
<div class="x-body">
    <form class="layui-form" action="${pageContext.request.contextPath}/Book/update" method="post">
    ...
    $(function() {
        ...
        $.post("${pageContext.request.contextPath}/Order/style",function(data){
            ...
            $("#field").change(function() {
                ...
                $.post("${pageContext.request.contextPath}/Order/category",{field:field},function(data){
