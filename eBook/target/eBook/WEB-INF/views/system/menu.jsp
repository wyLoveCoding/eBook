...
<script type="text/javascript">
    $(function () {
        ...
        var message = '${message}';
        if (message == "登陆成功") {
            $(".login_register_show").text("欢迎您，${sessionScope.user.username}");
        }
...
<div class="top">
    ...
    <div class="top-info">
        ...
        <a href="${pageContext.request.contextPath}/User/show" class="top-info-1">我的文轩</a>
        <div class="top-info-2">
            <a href="${pageContext.request.contextPath}/Shop/list">购物车</a>
            <div class="top-info-21"></div>
        </div>
        <div class="login_register_show" >
        <a href="${pageContext.request.contextPath}/ToPage/userLogin">登录</a>
        <a href="${pageContext.request.contextPath}/ToPage/regist">注册</a>
    </div>
    </div>
